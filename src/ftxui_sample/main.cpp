...
// configuration step. It creates a namespace called `victronSolarMonitor`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", victronSolarMonitor::cmake::project_name, victronSolarMonitor::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", victronSolarMonitor::cmake::project_version);
      return EXIT_SUCCESS;
    }
